...
INSERT INTO `services`(`id`,`name`,`active`,`category_id`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`main_image`) VALUES ( '7', 'Навесы зданий и сооружений', '1', '6', '', 'navesyi-zdaniy-i-soorujeniy', 'd0ed1b8e3212bf9eea6f816ba9449e25', '', '', '', '1', '[]', '' );
...
', 'tentovyie-pavilonyi', 'a513d150ba4713ff596e30002c516392', 'Желаете получить тентовый павильон высококлассного качества за разумную цену? Звоните нам в ООО "Айрон Продакшн". Собственная производственная база, надежные материалы от проверенных поставщиков, опытная команда, тысячи воплощенных в жизнь проектов. ', '', '', '2', '[]', '' );
...
', 'palatki-dlya-torgovli', '29f42fae3eecffc08f31dc61affc09e5', 'Где купить разборную палатку для уличной выездной торговли? Те, кто бережет свои финансы, время и спокойствие, уже давно сделали свой выбор. Присоединяйтесь к тем, кто выбирает качество по доступным ценам: звоните в ООО «Айрон Продакшн»!', '', '', '3', '[]', '' );
INSERT INTO `services`(`id`,`name`,`active`,`category_id`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`main_image`) VALUES ( '10', 'Остановочные павильоны', '1', '6', '', 'ostanovochnyie-pavilonyi', 'bd420b55a6715d61f3b7a9336c320634', '', '', '', '4', '[]', '' );
...
<p>&nbsp;</p>
', 'byitovka-metallicheskaya', 'ed295be89d4222592a98daacac04f3bf', 'Вы ищете, где заказать функциональную, доступную и комфортную металлическую бытовку для дачи или строительства? Вас интересуют разумные цены и быстрые сроки? Обращайтесь напрямую в ООО «Айрон Продакшн» и экономьте свои средства без ущерба в надежности.', '', '', '5', '[]', '' );
...
<p>&nbsp;</p>
', 'kioski', 'e608b4de1f41f181125b19402723c4ae', 'Ищете, где купить киоск в Минске по демократичной цене, но при этом не проиграть в качестве конструкции? Звоните напрямую в «Айрон Продакшн»! Изготовление киосков на собственной производственной базе, оптимальные сроки, тщательная сборка из долговечных ма', '', '', '6', '[]', '' );
INSERT INTO `services`(`id`,`name`,`active`,`category_id`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`main_image`) VALUES ( '13', 'Модернизация заправок', '1', '6', '', 'modernizatsiya-zapravok', 'aebd1689cf8cd29dbb1d7afc1d2491b1', '', '', '', '7', '[]', '' );
...
', 'stroitelstvo-avtomoek', '6e54386fdb3486f50133a1d1cd515086', 'Какой компании доверить строительство автомойки? Как можно быть уверенным в 100%-й безопасности и надежности постройки? Где найти выгодные цены, которые впишутся в рациональный бюджет? Звоните — мы воплощаем строгие требования в практичную реальность.', '', '', '9', '[]', '' );
...
', 'stroitelstvo-gipermarketov', '4f5595868dafd2ae409e9daab179b36d', 'Ищете подрядчика для строительства гипермаркета из металлоконструкций? Доверяйте репутации! ООО «Айрон Продакшн» — это собственное масштабное производство, персонал с колоссальным опытом и серьезное оборудование. Просто свяжитесь с нами. ', '', '', '10', '[]', '' );
...
<p>&nbsp;</p>
', 'stroitelstvo-kartofelehranilisch', 'f003f9027123c3b59b7103a707ad03c5', 'Что означает строительство картофелехранилищ с «Айрон Продакшн»? Вы тратите меньше, получаете готовый объект быстрее и на 100% уверены в надежности результата. Разве не этого хочет каждый представитель фермерского хозяйства?', '', '', '11', '[]', '' );
...
Минимальные цены без переплат. Возведение сложных объектов в краткие сроки. Любые масштабы.', '', '', '12', '[]', '' );
...
<p>&nbsp;</p>
', 'stroitelstvo-ptitseferm', 'd5bf62c50b7466d24bda416d4d5c5617', 'Кому заказать строительство птицефермы — без чрезмерных затрат, но так, чтобы не пострадало качество? Где найти партнера, который имеет серьезный опыт и на деле знает все тонкости возведения зданий для фермерских хозяйств? Ответ перед вами — переложите вс', '', '', '13', '[]', '' );
...
<p>Звоните!</p>
', 'stroitelstvo-svinoferm', '131a99ad40a4413bb223d7c862340b17', 'Строительство свиноферм с компанией «Айрон Продакшн» — профессионально, прочно, доступно. Хотите получить готовый ангар для свиней в минимальные сроки и по выгодной цене? Звоните! Собственное производство, ответственный подход.', '', '', '14', '[]', '' );
...
', 'stroitelstvo-holodilnyih-kamer', '6869200a85a33036cf4c2cd58e0676f4', 'Почему строительство холодильных камер стоит заказать в компании «Айрон Продакшн»? Огромный опыт реализации сложный проектов, компетентная команда, собственное производство и современное оборудование. Мы работаем на ваш результат!', '', '', '16', '[]', '' );
...
<p>&nbsp;</p>
', 'stulya-metallicheskie', 'd0c56f2d2ec4c9a927cfa884578009e8', 'Хотите купить поворотные стулья для бара в Минске? Обращайтесь в «Айрон Продакшн». Изготовление на собственном производстве. Крупный опт и мелкие партии. Лояльные цены. Проверенное качество.  ', '', '', '1', '[]', '' );
...
<p>&nbsp;</p>
', 'stalnoy-ugolok', '4c8a71c5301ef540e7120b60105d7ac9', 'Хотите купить металлический уголок по оптовым ценам в Минске? Партии любого объема — всегда в наличии на складах «Айрон Продакшн». Поставки напрямую с заводов без переплат.', '', '', '1', '[]', '' );
...
<p>Готовы обсудить детали заказа? Хотите задать дополнительные вопросы? Желаете запросить расчет стоимости? Звоните!</p>
', 'list-stalnoy', '05e33ee0e42bed12e6a346779d54c012', 'Вы ищете, где заказать функциональную, доступную и комфортную металлическую бытовку для дачи или строительства? Вас интересуют разумные цены и быстрые сроки? Обращайтесь напрямую в ООО «Айрон Продакшн» и экономьте свои средства без ущерба в надежности.', '', '', '2', '[]', '' );
INSERT INTO `services`(`id`,`name`,`active`,`category_id`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`main_image`) VALUES ( '29', 'арматура стальная', '1', '8', '', 'armatura-stalnaya', '23239a7ee3ad1a80ee277dfb75fec990', '', '', '', '3', '[]', '' );
...
<p>&nbsp;</p>
', 'shveller-stalnoy', 'db89b1f613bc9dad9a5d0ddd94fd8c0c', 'Хотите купить стальной швеллер напрямую со склада в Минске? Избежать волокиты и ожиданий? Получить низкие цены за высококачественную продукцию? Ждем вас в «Айрон Продакшн»!', '', '', '4', '[]', '' );
...
<p>&nbsp;</p>
', 'truba-profilnaya', '556913ed5ee44470787974d2ef9b3aa5', 'Приглашаем с выгодой купить металлическую профильную трубу в Минске: 20х20, 20х40, 40х20, 40х40,60х60. Низкие цены за метр. Прямые поставки с комбинатов.', '', '', '5', '[]', '' );
...
<p>&nbsp;</p>
', 'truba-stalnaya', '82a14645a46a6642fdd099272f49e152', 'Ищете надежного поставщика стальной трубы ВГП в Минске? Вас интересуют прямые поставки с заводов и адекватные цены? Все это вы найдете в «Айрон Продакшн».', '', '', '6', '[]', '' );
...
<p>&nbsp;</p>
', 'kvadrat-stalnoy', '5ec399dcf73a9f9edaa44df987aead4e', 'Купить стальной квадрат по низким ценам без переплат — возможно, если иметь дело с проверенным поставщиком. «Айрон Продакшн»: наши деловые связи работают на вас.', '', '', '7', '[]', '' );
INSERT INTO `services`(`id`,`name`,`active`,`category_id`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`main_image`) VALUES ( '34', 'круг пруток стальной', '1', '8', '', 'krug-prutok-stalnoy', '237530d9d756af46c4f31db4a7a7ae16', '', '', '', '8', '[]', '' );
INSERT INTO `services`(`id`,`name`,`active`,`category_id`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`main_image`) VALUES ( '35', 'лист перфарированный', '1', '8', '', 'list-perfarirovannyiy', '2db1e2e3c2d7cebb6a4ddbb23e1f3f90', '', '', '', '9', '[]', '' );
...
<p>&nbsp;</p>
', 'truba-elektrosvarnaya', 'e01614f6940e7b8f32909d96d271376f', 'Ищете возможность по лояльным ценам купить стальную электросварную трубу высокого уровня производства? Просто позвоните в ООО «Айрон Продакшн». Постоянное наличие.', '', '', '11', '[]', '' );
...
<p>&nbsp;</p>
', 'polosa-metallicheskaya', '733c82adc16a63d4075ff004af5335d4', 'ООО «Айрон Продакшн» приглашаем купить металлическую полосу 40х4 и пр. по специальным оптовым ценам. Серьезный ассортимент всегда в наличии на собственном складе в Минске.', '', '', '12', '[]', '' );
...
<p>&nbsp;</p>
', 'list-otsinkovannyiy', '181ddd12ae228ede23dcd982040d1578', 'Возникла необходимость купить оцинкованный лист в Минске? Вас интересует опт или розница? Ищете выгодные цены? «Айрон Продакшн» — это прямые продажи от производителей.', '', '', '13', '[]', '' );
...
<p>&nbsp;</p>
', 'izgotovlenie-tribun-iz-metalla', 'a6c7d070636adc61b3aecece1ab34539', 'Изготовление трибун из металла — это задача, которую можно смело доверять «Айрон Продакшн». Сотни успешно завершенных проектов, минимальные цены, собственные производственные цеха.', '', '', '17', '[]', '' );
...
<p>&nbsp;</p>
', 'balka', '05fda92721840be1036c5cca7f2aa625', 'Где купить металлическую балку в Минске по ценам первого поставщика? Обращайтесь в «Айрон Продакшн». Полный ассортимент на нашем складе, готовность к быстрой отгрузке.', '', '', '14', '[]', '' );
