...
', 'palatki-dlya-torgovli', '29f42fae3eecffc08f31dc61affc09e5', 'Где купить разборную палатку для уличной выездной торговли? Те, кто бережет свои финансы, время и спокойствие, уже давно сделали свой выбор. Присоединяйтесь к тем, кто выбирает качество по доступным ценам: звоните в ООО «Айрон Продакшн»!', '', '', '3', '[]', '/files/service/9/64bdd5484b3779164f9e8c3e11814c08.png' );
INSERT INTO `services`(`id`,`name`,`active`,`category_id`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`main_image`) VALUES ( '10', 'Остановочные павильоны', '1', '6', '', 'ostanovochnyie-pavilonyi', 'bd420b55a6715d61f3b7a9336c320634', '', '', '', '4', '[]', '/files/service/10/ae9ad87c32bdfe90114192474f60b84c.png' );
